...
enum Achievements {
    ...
    Achievement(id: "sunfish_1", icon: "🐡", stat: "sunfish", threshold: 1, ko: "개복치 등장", en: "Sunfish Drifts In", koDesc: "개복치 1회 목격", enDesc: "sunfish seen 1x"),
    ...
    Achievement(id: "watermelon_1", icon: "🍉", stat: "watermelon", threshold: 1, ko: "여름의 맛", en: "Taste of Summer", koDesc: "수박 1조각 먹힘", enDesc: "1 watermelon eaten"),
